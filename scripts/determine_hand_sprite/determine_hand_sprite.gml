...
function determine_hand_sprite(){
	if (instance_exists(hold_box_parent) && instance_exists(hold_box_parent.hold_to_display)) {
		...
		var _side = hold_box_parent.hold_box_type;
		if (_side == HOLD_BOX_TYPE.RIGHT) {
			if (disabled) {
			...
			if (disabled) {
				if (state == HAND_STATES.SEEKING) {
					sprite_index = spr_left_hand_open;
				} else {
					switch (_hold_type) {
						case HOLD_TYPE.MONO:
							sprite_index = spr_left_hand_mono;
							break;
						case HOLD_TYPE.CRIMP:
							sprite_index = spr_left_hand_crimp;
							break;
						case HOLD_TYPE.SLOPE:
							sprite_index = spr_left_hand_edge;
							break;
						case HOLD_TYPE.JUG:
							sprite_index = spr_left_hand_jug;
							break;
					}
				}
			} else {
				switch (_hold_type) {
					case HOLD_TYPE.MONO:
						sprite_index = spr_left_hand_mono_open;
						break;
					case HOLD_TYPE.CRIMP:
						sprite_index = spr_left_hand_crimp_open;
						break;
					case HOLD_TYPE.SLOPE:
						sprite_index = spr_left_hand_edge_open;
						break;
					case HOLD_TYPE.JUG:
						sprite_index = spr_left_hand_jug_open;
						break;
				}
			}
		}
